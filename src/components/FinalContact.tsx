          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 text-left">
              ...
              <motion.h2 
                ...
                className="text-3xl sm:text-5xl lg:text-6xl font-black font-['Space_Grotesk',sans-serif] tracking-tight text-white mb-6"
              >
                Pronto para estruturar <br />
                <span className="text-blue-500">sua operação?</span>
              </motion.h2>
              ...
              >
                Agende um diagnóstico com Leonardo. Vamos analisar onde sua empresa está perdendo oportunidades e estruturar aquisição, CRM e comercial para vender com previsibilidade.
              </motion.p>
              ...
              >
                <motion.button
                  ...
                  className="px-8 py-4 rounded-2xl bg-blue-600 text-white font-bold text-xs uppercase tracking-wider hover:bg-blue-500 shadow-xl shadow-blue-500/30 transition-all flex items-center justify-center gap-3 w-fit"
                >
            ...
            >
              <div className="bg-[#0f172a] border border-blue-500/20 rounded-3xl p-8 space-y-6 shadow-xl">
                ...
                {/* Email */}
                <a
                  href="mailto:leonardo@leonardoassessoria.com.br"
                ...
                >
                  ...
                  <div className="overflow-hidden">
                    ...
                    <div className="font-['Space_Grotesk',sans-serif] font-bold text-white text-base truncate">
                      leonardo@leonardoassessoria.com.br
                    </div>
                  </div>
                </a>

      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-500/10 border border-blue-500/30 text-blue-400 text-xs font-bold uppercase tracking-wider mb-6 w-fit">
            ...
            <span>Simulador de Perda de Receita</span>
          </div>
          <h2 className="text-3xl sm:text-5xl lg:text-6xl font-black font-['Space_Grotesk',sans-serif] text-white tracking-tight leading-tight mb-6">
            Quanto dinheiro sua empresa <br className="hidden sm:block" />
            <span className="text-blue-500">deixa na mesa?</span>
          </h2>
          <p className="text-base sm:text-lg text-white/70 leading-relaxed max-w-2xl mx-auto font-medium">
            Veja o impacto de perder oportunidades por falta de processo comercial.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center max-w-5xl mx-auto">
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <motion.button
              ...
              className="w-full py-5 px-6 rounded-2xl bg-blue-600 hover:bg-blue-500 text-white font-bold text-xs uppercase tracking-wider transition-all flex items-center justify-center gap-3 shadow-lg shadow-blue-500/25 group"
            >
              <span>Quero identificar onde estou perdendo vendas</span>

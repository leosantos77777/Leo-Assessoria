      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-5xl font-black font-['Space_Grotesk',sans-serif] text-white tracking-tight leading-tight mb-4">
            Métricas reais de operações <br className="hidden sm:block" />
            <span className="text-blue-500">estruturadas de ponta a ponta.</span>
          </h2>
          <p className="text-base text-white/60 leading-relaxed max-w-xl mx-auto">
            Volume gerenciado, escala e histórico acumulado em mais de meia década no campo de batalha.
          </p>
        </motion.div>

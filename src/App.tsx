  ...
  return (
    <div className="min-h-screen bg-[#07090e] text-white flex flex-col selection:bg-blue-500/30 selection:text-white font-['Plus_Jakarta_Sans',sans-serif]">
      ...
      <main className="flex-1">
        ...
        {/* Dor, 3 Pilares e Método (Da oportunidade à venda) */}
        <RevealWrapper>
          <ThreePillars onOpenDiagnostic={handleOpenDiagnostic} />
        </RevealWrapper>

        {/* Autoridade do Leonardo, Cases Shark Tank e LogSchool */}
        <RevealWrapper>
          <LeonardoStory onOpenDiagnostic={handleOpenDiagnostic} />
        </RevealWrapper>

        {/* Simulador: Consciência de Dinheiro Perdido */}
        <RevealWrapper>
        ...
        {/* Para Quem É & Nichos de Atuação */}
        <RevealWrapper>
          <NichesSection onOpenDiagnostic={handleOpenDiagnostic} />
        </RevealWrapper>

        {/* Soluções e Assessoria de Marketing & Vendas */}
        <RevealWrapper>
          <PricingSection onOpenDiagnostic={handleOpenDiagnostic} />
        </RevealWrapper>
